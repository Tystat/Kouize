<?php
	...
	if (!Users::isSuperUser()){
		 header('Location: /');	// Vérifie si l'utilisateur est admin, le renvoie sur l'index s'il ne l'est pas.
		 die();
	}
	...
	*/
	...
	$questionsList = $quest->getUnvalidQuestion();
				...
				<tbody>
					...
					?>
							<tr>
								  ...
								  <td><a role="button" class="btn btn-info" href="process_valid-question.php?questionId=<?= $question['id'] ?>" >Valider</a></td>
